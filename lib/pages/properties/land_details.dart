...
class LandDetailState extends StatefulWidget {
  const LandDetailState({super.key});

  @override
  State<LandDetailState> createState() => _LandDetailStateState();
}

class _LandDetailStateState extends State<LandDetailState> {
  @override
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/land-3.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
